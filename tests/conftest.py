...
def _set_env(monkeypatch, tmp_path_factory):
    ...
    monkeypatch.setenv("RATE_LIMIT_DOC_PER_MIN", "60")
    monkeypatch.setenv("RATE_LIMIT_IMAGE_PER_MIN", "60")
    monkeypatch.setenv("RATE_LIMIT_AUDIO_PER_MIN", "20")
    monkeypatch.setenv("RATE_LIMIT_VIDEO_PER_MIN", "10")
    monkeypatch.setenv("DLQ_TOPIC", "")
