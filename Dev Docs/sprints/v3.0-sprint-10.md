...
- [x] Add scoped API keys and auth enforcement retikon_core/auth/.
...
- [x] Update Dev Docs/Load-Testing.md with streaming/compaction benchmarks.
- [x] Add text-only vs multimodal query baselines to Dev Docs/Load-Testing.md.
...
- Streaming ingest knee sweep recorded in `Dev Docs/Load-Testing.md` (2026-01-27).
